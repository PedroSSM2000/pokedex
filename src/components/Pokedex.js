...
export default function Pokedex({ location: { id = 1 } }) {
  ...
  return (
    <div className="flex flex-col items-center text-center bg-secondary min-h-screen overflow-hidden">
      <Header />
      <form
      ...
      >
        <div className="rounded-lg pl-3 py-2 bg-primary shadow-md">
          <label>
            #
            <input
              className="ml-1.5 w-9 rounded-full bg-secondary text-center placeholder:text-text-secondary"
              type="text"
              placeholder="ID"
              value={pokemonID}
          ...
          <input
            className="mx-2 w-28 text-center capitalize bg-secondary rounded-full placeholder:text-text-secondary"
            placeholder="Pokemon"
            value={pokemonSearch}
            onChange={({ target: { value } }) => {
      ...
      <div className="flex flex-wrap items-center justify-center w-full mt-4 px-8">
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("grass", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "grass" ? "outline outline-2" : ""
          } `}
        >
          Grass
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("fire", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "fire" ? "outline outline-2" : ""
          } `}
        >
          Fire
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("water", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "water" ? "outline outline-2" : ""
          } `}
        >
          Water
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("bug", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "bug" ? "outline outline-2" : ""
          } `}
        >
          Bug
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("normal", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "normal" ? "outline outline-2" : ""
          } `}
        >
          Normal
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("electric", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "electric" ? "outline outline-2" : ""
          } `}
        >
          Electric
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("psychic", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "psychic" ? "outline outline-2" : ""
          } `}
        >
          Psychic
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("ice", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "ice" ? "outline outline-2" : ""
          } `}
        >
          Ice
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("ground", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "ground" ? "outline outline-2" : ""
          } `}
        >
          Ground
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("rock", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "rock" ? "outline outline-2" : ""
          } `}
        >
          Rock
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("fighting", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "fighting" ? "outline outline-2" : ""
          } `}
        >
          Fighting
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("ghost", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "ghost" ? "outline outline-2" : ""
          } `}
        >
          Ghost
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("dragon", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "dragon" ? "outline outline-2" : ""
          } `}
        >
          Dragon
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("flying", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "flying" ? "outline outline-2" : ""
          } `}
        >
          Flying
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("poison", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "poison" ? "outline outline-2" : ""
          } `}
        >
          Poison
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("dark", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "dark" ? "outline outline-2" : ""
          } `}
        >
          Dark
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("steel", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "steel" ? "outline outline-2" : ""
          } `}
        >
          Steel
        </button>
        <button
          onClick={() => {
            ...
            lastChanged = "id";
            fetchPokemon(
              getNearestSameTypePokemon("fairy", pokemon.id),
              pokemon.name
            );
          }}
          className={` mt-4 mx-2 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary ${
            selected === "fairy" ? "outline outline-2" : ""
          } `}
        >
          Fairy
        </button>
      ...
      <div className="relative">
        <button
          className="absolute top-1/2 -left-8 -translate-y-1/2 -translate-x-full bg-primary py-1 px-2 rounded shadow-md hover:bg-secondary"
          onClick={() => {
            lastChanged = "id";
            if (pokemonID <= 1) return;
            fetchPokemon(
              getPreviousSameTypePokemon(selected, pokemonID),
              pokemonSearch
            );
          }}
        >
        ...
        {loading ? (
          <div className="shadow-xl rounded-xl h-36 aspect-[2/1] bg-primary flex items-center justify-center my-8 overflow-hidden">
            <img
        ...
        <button
          className="absolute top-1/2 -right-8 -translate-y-1/2 translate-x-full bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary"
          onClick={() => {
            lastChanged = "id";
            if (pokemonID >= 898) return;
            fetchPokemon(
              getNextSameTypePokemon(selected, pokemonID),
              pokemonSearch
            );
          }}
        >
      ...
      <div>
        <Link
          className="inline-block mr-8 bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary"
          to={`/pokemon/${pokemonID}`}
        >
          Details
        </Link>
        <Link
          className="inline-block bg-primary py-1 px-2 rounded shadow-md transition hover:bg-secondary"
          to={`/favorites`}
        >
          Favorites
        </Link>
